...
public abstract class BoardItemData : ScriptableObject
{
    ...
    public abstract void OnRemoved(LegBoard board, BoardItemType destroyer, BoardSlot slot);
    public abstract void OnSwiped(LegBoard board, int direction, BoardSlot slot);
